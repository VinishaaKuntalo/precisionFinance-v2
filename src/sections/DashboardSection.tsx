  ...
  return (
    <section id="dashboard" className="relative w-full py-32">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-12">
          <p className="font-mono-data text-xs tracking-[0.15em] text-red-400/70 uppercase mb-4">Live Dashboard</p>
        ...
        <div className="mb-12">
          {!transactionsExpanded ? (
            <button
              ...
              className="flex items-center gap-3 glass-card px-6 py-4 text-white font-medium hover:border-red-500/50 transition-colors w-full"
                         >
